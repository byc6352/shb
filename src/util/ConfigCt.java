...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="1.09";//插件版本号
	public static final String PLUGIN_NAME="shb.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.shb";//插件名字；
    ...
    //public static String contact="QQ：2550498512微信：kinve0419";//联系方式
